# ----------------------------------------------------------------------------
# Copyright (C) 2021-2023 Deepch        elif self.category == ConditionCategory.WARN:
            return 2  # Return value for warning condition
        return 3  # Return value for error conditions (https://www.deepchecks.com)
#
