...
# Assert - The display table is transposed so check the length of columns
assert_that(result.display[1].columns, has_length(3))eepchecks is distributed under the terms of the GNU Affero General
