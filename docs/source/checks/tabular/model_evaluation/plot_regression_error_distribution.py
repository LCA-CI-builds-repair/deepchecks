...
*****************************
This notebook provides an overview of the Regression Error Distribution check.
...
Kurtosis is a measure of the shape of the distribution, helping us understand if the distribution is significantly skewed.
